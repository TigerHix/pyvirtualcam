...
private:
	bool Open(bool ForReceiving)
	{
		...
		char CS_NAME_MUTEX      [] = "WarudoCapture_Mutx0"; CS_NAME_MUTEX      [sizeof(CS_NAME_MUTEX      ) - 2] = CSCapNumChar;
		char CS_NAME_EVENT_WANT [] = "WarudoCapture_Want0"; CS_NAME_EVENT_WANT [sizeof(CS_NAME_EVENT_WANT ) - 2] = CSCapNumChar;
		char CS_NAME_EVENT_SENT [] = "WarudoCapture_Sent0"; CS_NAME_EVENT_SENT [sizeof(CS_NAME_EVENT_SENT ) - 2] = CSCapNumChar;
		char CS_NAME_SHARED_DATA[] = "WarudoCapture_Data0"; CS_NAME_SHARED_DATA[sizeof(CS_NAME_SHARED_DATA) - 2] = CSCapNumChar;
