...
if platform.system() == 'Windows':
    from pyvirtualcam import _native_windows_obs, _native_windows_unity_capture, _native_windows_warudo
    register_backend('obs', _native_windows_obs.Camera)
    register_backend('unitycapture', _native_windows_unity_capture.Camera)
    register_backend('warudo', _native_windows_warudo.WarudoCamera)
